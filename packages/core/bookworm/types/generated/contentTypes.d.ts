...
export interface ApiBookBook extends Schema.CollectionType {
  ...
  attributes: {
    ...
    hasEbook: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<false>;
    imageCover: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    language: Attribute.Enumeration<['Ti\u1EBFng Vi\u1EC7t,', 'English']>;
    publishAt: Attribute.Date;
    stock: Attribute.Integer;
    edition: Attribute.String;
    pageCount: Attribute.Integer;
    tags: Attribute.Relation<'api::book.book', 'manyToMany', 'api::tag.tag'>;
    categories: Attribute.Relation<'api::book.book', 'manyToMany', 'api::category.category'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::book.book', 'oneToOne', 'admin::user'> & Attribute.Private;
    updatedBy: Attribute.Relation<'api::book.book', 'oneToOne', 'admin::user'> & Attribute.Private;
  };
}
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    books: Attribute.Relation<'api::category.category', 'manyToMany', 'api::book.book'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiIntroduceIntroduce extends Schema.SingleType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::introduce.introduce', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::introduce.introduce', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiPublisherPublisher extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::publisher.publisher', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::publisher.publisher', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    bookCount: Attribute.String;
    books: Attribute.Relation<'api::tag.tag', 'manyToMany', 'api::book.book'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiTermAndPolicyTermAndPolicy extends Schema.SingleType {
  collectionName: 'term_and_policies';
  info: {
    singularName: 'term-and-policy';
    pluralName: 'term-and-policies';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::term-and-policy.term-and-policy',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::term-and-policy.term-and-policy': ApiTermAndPolicyTermAndPolicy;
    }
  }
}
